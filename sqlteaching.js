...
var levels = [{'name': 'SELECT',
               ...
               'answer': {'columns': ['Placa'],
                          'values': [['LLL0000'],
                                     ['LXZ3333']]},
               'prompt': 'Quais são as placas dos carros modelo "Palio"?'},
              ...
              {'name': 'SELECT colunas específicas',
               ...
               'answer': {'columns': ['Placa', 'Cor', 'Modelo'],
                          'values': [['LLL0000', 'Prata', 'Palio'],
                                     ['LXZ3333', 'Preto', 'Palio']]},
               'prompt': 'Apresente as placas, cores e modelos dos carros modelo "Palio".'},
              ...
              {'name': 'SELECT *',
               ...
               'prompt': 'Apresente todos os campos da tabela "carro".'},
              ...
              {'name': 'SELECT TELEFONE',
               ...
               'answer': {'columns': ['Telefone'],
                          'values': [[26215850]]},
               'prompt': 'Qual é o telefone da cliente chamada "Joana"?'},
              ...
              {'name': 'INNER JOIN',
               ...
               'prompt': 'Junte as tabelas <strong>carro</strong> e <strong>venda</strong>. <br/><br/> Dica: Utilize o comando <code>INNER JOIN</code> començando pela tabela <strong>carro</strong>.'},
