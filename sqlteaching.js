...
var levels = [{'name': 'SELECT',
              ...
              {'name': 'DATA 10/2020',
               ...
               'answer': {'columns': ['IDCliente'],
                          'values': [[3],
                                     ...
                                     [2],
                                     [4]]},
               'prompt': '</br>Quais os IDs dos clientes que já devolveram filmes com 7 dias ou mais de atraso?'},
              ...
              {'name': 'SUM',
               ...
               'answer': {'columns': ['SUM(Valor)'],
                          'values': [[67]]},
               'prompt': '</br>Qual é a receita total das locações realizadas no ano de 2020?'},
              ...
              {'name': 'COUNT, AVG, MAX, MIN',
               ...
               'prompt': '</br>Qual é a quantidade de locações devolvidas no ano de 2020, a sua média de valor, o valor da maior locação feita e da menor locação?'},
              ...
              {'name': 'GROUP BY',
               ...
               'answer': {'columns': ['Receita', 'Modelo'],
                          'values': [[50000, 'Meriva'],
                                     [78000, 'Palio'],
                                     [45000, 'Punto']]},
               'prompt': 'Qual é a receita das vendas de cada modelo em <strong>2021</strong>?<br></br>Dica: utilize o comando <code>AS</code> para mudar o nome da variável para <strong>"Receita"</strong>'},
              ...
              {'name': 'ORDER BY',
               ...
               'answer': {'columns': ['Média', 'Modelo', 'Ano'],
                          'values': [[45000, 'Punto', 2019],
                                     [50000, 'Meriva', 2017]]},
               'prompt': '</br> Qual foi o valor médio das vendas de cada modelo para cada ano de fabricação em <strong>2021</strong>? Considere apenas as médias superiores a 40000, e apresente os resultados em ordem decrescente do ano de fabricação.'},
